...
- L'embauche a ralenti après les licenciements post-Covid ; il est difficile de sortir diplômé en informatique aujourd'hui.
- L'IA absorbe les petits changements et bug fixes qui étaient les tâches d'entraînement parfaites pour les juniors.
- Les managers qui développaient traditionnellement les jeunes talents sont surchargés ou supprimés.
- Une rationalité court-termiste existe en P&L, mais les conséquences de long terme sont inquiétantes.
- Le pipeline traditionnel : embauche junior, binôme avec un senior, tâches existant autant pour l'apprentissage que pour le travail.
- Le jugement — compétence clé du senior — se bâtissait par répétition et correction (code, PR, feedback, correction).
